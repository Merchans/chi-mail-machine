(function ($) {
    ...
    $(function () {
        ...
        btn.on('click', function (e) {
            ...
            var adminState = $('#chi_email_admin_state');
                    ...
                    switch (option) {
                        ...
                        case "2":
                            $('ul.order_notes').prepend('<li rel="" class="note">\n' +
                                ...
                                '\t\t\t\t\t</li>');
console.log(data);
                            if (adminState.attr('checked', false)) {

                                $.ajax({
                                    url: ajaxurl, // Since WP 2.8 ajaxurl is always defined and points to admin-ajax.php
                                    data: {
                                        'action': 'email_admin_done', // This is our PHP function below
                                        'post_id': thisID,
                                        // This is the variable we are sending via AJAX
                                    },
                                    success: function (data) {
                                        console.log(data);
                                        adminState.attr('checked', true);
                                    },
